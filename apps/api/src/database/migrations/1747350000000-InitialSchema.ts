    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'body_text', type: 'longtext', isNullable: true },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'teacher_id', type: 'bigint' },
          { name: 'reflection_text', type: 'longtext' },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'teacher_id', type: 'bigint' },
          { name: 'comment_text', type: 'longtext', isNullable: true },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'text_content', type: 'longtext', isNullable: true },
          { name: 'file_id', type: 'bigint', isNullable: true },
          { name: 'created_at', type: 'datetime', default: 'CURRENT_TIMESTAMP' },
        ],
      }),
