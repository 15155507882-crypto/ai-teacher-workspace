...
export default function PlansPage() {
  ...
  useEffect(() => {
    fetch('/api/teachers/1/contents?content_type=plan_summary&size=500', {
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl border overflow-hidden">
            ...
            {filtered.length === 0 && (
              <div className="p-12 text-center text-slate-400">暂无计划与总结</div>
            )}
          </div>
        )}
          ...
          {detail && (
            <div className="space-y-5">
              <div className="flex gap-2">
                <Badge variant="purple">{detail.plan_type || '计划总结'}</Badge>
              ...
              <div>
                <h4 className="text-sm font-medium text-slate-600 mb-3">留言记录</h4>
